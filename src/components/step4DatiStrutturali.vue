...
<div class="bgmargintop">
  ...
  <div class="row">
    ...
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.datistrutturalichk" val="EdificioinMuraturaPortante" label="Edificio in Muratura Portante"  :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.datistrutturalichk" val="EdificioTelaioCAinopera" label="Edificio con telaio in C.A. in opera" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.datistrutturalichk" val="EdificioElementiPrefabbricati" label="Edificio con elementi prefabbricati" :disable="!value.modificaAttivo"/></div>
  ...
  <div class="row">
    ...
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="Laterizio" label="Laterizio" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="MuraturaCassaVuota" label="Muratura a cassa vuota" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="MuraturaCassaIsolanteIntercapedine" label="Muratura a cassa con isolante in intercapedine" :disable="!value.modificaAttivo" /></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="Tufo" label="Tufo" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="Gasbeton" label="Gasbeton" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologiaParetechk" val="altro" label="Altro" :disable="!value.modificaAttivo"/></div>
 ...
 <div class="row">
    ...
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologia_doppia_parete" val="presenzaIntercapedite" label="Presenza intercapedine/camera d’aria" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologia_doppia_parete" val="IsolamentoInCameraDaria" label="Isolante in camera d’aria (sughero, EPS, ecc…)" :disable="!value.modificaAttivo"/></div>
    <div class="col-5 col-md-3"><q-checkbox right-label v-model="value.tipologia_doppia_parete" val="idoneoInsuffiaggio" label=" Idoneo a insufflaggio" :disable="!value.modificaAttivo"/></div>
    <div class="row">
    <div class="col-4 paddingInput">
    <label for="">Spessori muri esterni (cm)</label>
    <q-input v-model="value.SpessoreMuriEsterni" type="text" outlined :dense="true" :disable="!value.modificaAttivo"/>
    </div>
    <div class="col-4 paddingInput">
    <label for="">Spessoricamera d'aria (cm)</label>
    <q-input v-model="value.SpessoreCameraDaria" type="text" outlined :dense="true" :disable="!value.modificaAttivo"/>
    </div>
    <div class="col-4 paddingInput">
    <label for="">Spessori Isolamento (cm)</label>
    <q-input v-model="value.SpessoreIsolamento" type="text" outlined :dense="true" :disable="!value.modificaAttivo"/>
    </div>
    <div class="col-4 paddingInput">
    <label for="">Tipo isolante in camera d’aria</label>
    <q-input v-model="value.TipologiaIsolamentoIncameraDaria" type="text" outlined :dense="true" :disable="!value.modificaAttivo"/>
    </div>
   </div>
 ...
 <div class="row">
    ...
    <div class="col-3"><q-checkbox right-label v-model="value.isolamentoEsistentechk" val="eps" label="EPS" :disable="!value.modificaAttivo"/></div>
    <div class="col-3"><q-checkbox right-label v-model="value.isolamentoEsistentechk" val="sughero" label="Sughero" :disable="!value.modificaAttivo"/></div>
    <div class="col-3"><q-checkbox right-label v-model="value.isolamentoEsistentechk" val="lanaDiroccaVetro" label="Lana di roccia/vetro " :disable="!value.modificaAttivo"/></div>
    <div class="col-3"><q-checkbox right-label v-model="value.isolamentoEsistentechk" val="altro" label="Altro" :disable="!value.modificaAttivo"/></div>
  ...
  <div class="row" v-if="value.isolamentoEsistentechk.includes('altro')">
    <div class="col">
      <q-input v-model="value.altroisolamentoEsistentechk" type="text" :dense="true" outlined label="Altro" :disable="!value.modificaAttivo"/>
      </div>
    </div>
</div>
...
<div class="row"><div class="col-12">
  ...
  <div class="col-12">
    <q-radio v-model="value.tipologiaImpiantoEsistente" val="centralizzato" label="Centralizzato" :disable="!value.modificaAttivo"/>
    <q-radio v-model="value.tipologiaImpiantoEsistente" val="autonomo" label="autonomo" :disable="!value.modificaAttivo"/>
    <q-radio v-model="value.tipologiaImpiantoEsistente" val="assente" label="assente" :disable="!value.modificaAttivo"/>
...
<div class="col-md-3 col-12 paddingInput">
  ...
  <q-select v-model="value.cetraleTermicaCentralizzatoTecnologiaImpiantoEsistente" :dense='true' outlined :options="tecnologieCentraliTermiche" value=''  label="Seleziona..." :disable="!value.modificaAttivo"/>
...
<div class="col-md-3 col-12 paddingInput">
  ...
  <q-input v-model="value.cetraleTermicaCentralizzatoNumeroUnita" outlined :dense="true" type="text" :disable="!value.modificaAttivo" />
  
  </div>
<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Anno di installazionee</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoAnnoInstallazione" outlined :dense="true" type="text"  :disable="!value.modificaAttivo"/>
  
  </div>
<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Potenza termica utile impianto esistente [kWt]</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoPotenzaTermicaImpiantoEsistente" outlined :dense="true" type="text" :disable="!value.modificaAttivo" />
  
  </div>
<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Tipologia di distribuzione esistente</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoTipologiaDistribuzioneEsiste" outlined :dense="true" type="text"  :disable="!value.modificaAttivo"/>
  
  </div>
<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Tipologia sistema di termoregolazione evoluta</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoTipologiaTermoregolazioneEsistente" outlined :dense="true" type="text" :disable="!value.modificaAttivo" />
  
  </div>
  <div class="col-md-12 col-12">
    <label for="" class="text-bold">Disponibilità libretto di impianto aggiornato</label><br>
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponibilitaLibrettoImpiantoAggiornato" val="SI" label="SI" :disable="!value.modificaAttivo"/>
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponibilitaLibrettoImpiantoAggiornato" val="NO" label="NO" :disable="!value.modificaAttivo" />
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponibilitaLibrettoImpiantoAggiornato" val="Assente" label="Assente" :disable="!value.modificaAttivo"/>
    <div v-if="value.cetraleTermicaCentralizzatoDisponibilitaLibrettoImpiantoAggiornato == 'SI'">
      ...
      outlined
      :dense="true"
      style="max-width: 300px" :disable="!value.modificaAttivo"/>

      </div>
  </div>
  <div class="col-md-12 col-12">
    <label for="" class="text-bold">Disponibilità prove fumi aggiornate</label><br>
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponbilitaProveFumiAggiornate" val="SI" label="SI" :disable="!value.modificaAttivo"/>
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponbilitaProveFumiAggiornate" val="NO" label="NO" :disable="!value.modificaAttivo"/>
    <q-radio v-model="value.cetraleTermicaCentralizzatoDisponbilitaProveFumiAggiornate" val="Assente" label="Assente" :disable="!value.modificaAttivo"/>
...
<div class="col-md-3 col-12 paddingInput">
  ...
  <q-select v-model="value.cetraleTermicaCentralizzatoTecnologiaImpiantoProposto" :dense='true' outlined :options="tecnologieCentraliTermiche"  :disable="!value.modificaAttivo"/>

  <q-input v-show="value.cetraleTermicaCentralizzatoTecnologiaImpiantoProposto.value == 'altro' " v-model="value.cetraleTermicaCentralizzatoTecnologiaImpiantoPropostonteAltro" outlined :dense="true" type="text" label="Specificare"  :disable="!value.modificaAttivo"/>
  
  </div>
<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Numero unità di generazione</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoNumeroUnitaProposte" outlined :dense="true" type="text"  :disable="!value.modificaAttivo"/>
  
  </div>

  <div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Potenza termica utile impianto esistente [kWt]</label>
  <q-input v-model="value.cetraleTermicaCentralizzatoPotenzaTermicaImpiantoProposto" outlined :dense="true" type="text" :disable="!value.modificaAttivo" />
  
  </div>

<div class="col-md-3 col-12 paddingInput">
  <label class="text-bold">Vettore energetico impianto</label>
  <q-input v-model="value.centraleTermivaCentralizzatoVettoreImpianto" outlined :dense="true" type="text" :disable="!value.modificaAttivo" />
    ...
    <div class="row"><div class="col">
      <q-btn  class="white" icon="add" label="Aggiungi" @click="modalAggiungiImpiantoEsistenteAutonomo=true" :disable="!value.modificaAttivo"/><!--TODO CAMBIARE CLICK BOTTONE MODAL -->
 ...
 <div  class="row" v-for="(item,index) in value.elencoImpiantoAutonomoEsistente" :key="item.message" style="border-bottom:1px solid black">
    ...
    <q-btn   size="sm" round icon="delete" @click="value.elencoImpiantoAutonomoEsistente.splice(index, 1)" :disable="!value.modificaAttivo"/>
  
  </div>
  </div>
    <div class="row"><div class="col"><span class="text-bold text-h5">Stato di Progetto</span></div></div>
    <div class="row"><div class="col">
      <q-btn  class="white" icon="add" label="Aggiungi" @click="modalAggiungiImpiantoEsistenteAutonomoStatoProgetto=true" :disable="!value.modificaAttivo"/><!--TODO CAMBIARE CLICK BOTTONE MODAL -->
