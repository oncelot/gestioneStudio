<template>
    <div style="color:grey">
         <div class="row">
        <hr>
        <div class="col-12"><b>Tipo Anagrafica</b></div>
        <div class="col-12">
            <q-radio v-model="nuovoAnagrafica.nuovaAnagraficaTipo" val="cliente" label="Cliente" />
            <q-radio v-model="nuovoAnagrafica.nuovaAnagraficaTipo" val="collaboratoreInterno" label="Collaboratore Interno" />
            <q-radio v-model="nuovoAnagrafica.nuovaAnagraficaTipo" val="collaboratoreEsterno" label="Collaboratore Esterno" />
        </div>
        </div>
<div class="row">
    <div class="col-12 col-md-3 padding10">
 <label for="" style="font-weight:bold"> Tipologia</label>
        <q-select v-model="nuovoAnagrafica.tipologia" :dense="true"  outlined :options="options"  v-bind:value="options.value"  /></div>

    <div class="col-12 col-md-3 padding10">
         <label for=""> Denominazione</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaDenominazione" type="text"  :dense="true" outlined placeholder="Denominazione azienda " />
    </div>

    <div class="col-12 col-md-3 padding10">
        <label for=""> Nome</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaNome" type="text" :dense="true" outlined />
    </div>
    <div class="col-12 col-md-3 padding10">
         <label for=""> Cognome</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaCognome" type="text" :dense="true" outlined />
    </div>
</div>
...
<div class="row">
    <div class="col-12 col-md-3  padding10">
        ...
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaPartitaIva" type="text" :dense="true" outlined  />
    </div>
    
    <div class="col-12 col-md-3  padding10">
         <label for="">Codice Fiscale</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaCodiceFiscale" type="text" :dense="true" outlined  />
    </div>
    <div class="col-12 col-md-3  padding10">
         <label for="">Telefono</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaTelefono" type="text" :dense="true" outlined  />
    </div>
    <div class="col-12 col-md-3  padding10">
         <label for="">Email</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaEmail" type="text" :dense="true" outlined placeholder="E-mail Separate da virgola"  />
    </div>
    <div class="col-12 col-md-3  padding10">
         <label for="">Email PEC</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaEmailPec" type="text" :dense="true" outlined placeholder="Singola Email"  />
    </div>
</div>
...
<div class="row">
    <div class="col-12 col-md-3  padding10">
        ...
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaPaese" type="text" :dense="true" outlined  />
    </div>
    
    <div class="col-12 col-md-3  padding10">
         <label for="">Indirizzo</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaIndirizzo" type="text" :dense="true" outlined  />
    </div>
    <div class="col-12 col-md-3  padding10">
         <label for="">Città</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaCitta" type="text" :dense="true" outlined  />
    </div>
    <div class="col-12 col-md-3  padding10">
         <label for="">Provincia</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaProvincia" type="text" :dense="true" outlined  />
    </div>
    
    <div class="col-12 col-md-3  padding10">
         <label for="">CAP</label>
        <q-input v-model="nuovoAnagrafica.nuovaAnagraficaCap" type="text" :dense="true" outlined  />
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col padding10">
        ...
        <q-btn color="primary"  label="Aggiorna" v-if="bottoneSalvaModifica=='modifica'" @click=" modificaAnagrafica(idutente) "  /> 
    </div>
</div>
