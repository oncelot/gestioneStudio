<template>
  <div class="q-gutter-sm">
    <div v-if="value.tipologiaEdificio == 'edificioFamiliare'"  class="bgmargintop q-gutter-sm " >
      <div class="row">
        <div class="col-12">
          <b>L’unità immobiliare è funzionalmente indipendente?</b>
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              N.B. L’U.I. è funzionalmente indipendente se è dotata di
              installazioni o manufatti <br />
      ...
      <div class="row">
        <div class="col-12">
          ...
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              N.B. L’U.I. è dotata di accesso autonomo se dispone di un accesso
              indipendente non comune ad <br />
              altre unità immobiliari chiuso da cancello o portone di ingresso
              che consenta l’accesso <br />
              dalla strada o dal cortile o giardino anche di proprietà non
              esclusiva.
            </q-tooltip>
          </q-icon>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <b
            >Il proprietario dell’immobile ha già usufruito o ha intenzione di
            usufruire della detrazione al 110% per altre unità immobiliari?</b
          >
        </div>
        <div class="col-12">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              ad es. rifacimento della pavimentazione, ringhiere, frontalini,
              ecc….
            </q-tooltip>
          </q-icon>
        </div>
    ...
    <div v-if="value.tipologiaEdificio == 'condominio'" class="bgmargintop q-gutter-sm  row">
      <div class="row">
        <div class="col-12">
          <b
            >E' presente un unico proprietario o comproprietari di tutte le u.i.
            del condominio?</b
          >
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              In caso di risposta affermativa, interrompere la compilazione del
              questionario e verificare la fattibilità dell’operazione con EHUB.
            </q-tooltip>
          </q-icon>
        </div>
        <div class="col-12">
      ...
      <div class="row">
        <div class="col-12">
          <b>Ci sono unità immobiliari di proprietà di soggetti IRES?</b>
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              I soggetti passivi IRES sono: - le società di capitali ed enti
              equiparati -enti pubblici/privati diversi dalle società che hanno
              come oggetto principale o esclusivo l’esercizio dell’attività
              commerciale - enti pubblici/privati diversi dalle società che non
              hanno come oggetto principale o esclusivo l’esercizio
              dell’attività commerciale - società ed enti di ogni tipo con o
      ...
      <div class="row">
        <div class="col-12">
          <b
            >Ci sono condòmini che possiedono più di due unità immobiliari
            all'interno del condominio?</b
          >
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              In caso di risposta affermativa, relativamente agli interventi
              realizzati sulle singole unità immobiliari, il condomìno potrà
              fruire della detrazione 110% su max 2 U.I. Tale limitazione non si
              applica alle spese sostenute per interventi realizzati sulle parti
      ...
      <div class="row">
        <div class="col-12">
          ...
          <q-icon name="info">
            <q-tooltip anchor="top middle" self="bottom middle">
              A1- Abitazione di tipo signorile A8- Abitazione in villa A9-
      ...
      <div class="row">
        <div class="col-12">
          <b
            >Ci sono condòmini che hanno già usufruito o che hanno intenzione di
            usufruire della detrazione al 110% per altre u. i. esterne al
            condominio??</b
          >
        </div>
        <div class="col-12">
    ...
    <div>
      <div class="bgmargintop q-gutter-sm row">
        <div class="col-12">
          <span class="text-h6 text-secondary">Titoli autorizzativi</span>
        </div>
        ...
        <div class="col-12">
          ...
          <q-input
            v-model="value.tipologiaTitoloAutorizzativi"
            type="text"
            outlined
            :dense="true"
            :disable="!value.modificaAttivo"
        ...
        <div class="col-3">
          ...
          <a
            ...
            @click="
              downloadFile(
                value.idprogetto + '/' + value.AllegatoTitoloAutorizzativo,
                value.AllegatoTitoloAutorizzativo
              )
            "
            >{{ value.AllegatoTitoloAutorizzativo }}</a
          >
        ...
        <div class="col-12">
          <div class="row q-gutter-sm">
            <div class="col-12 col-md-12">
              <b
                >Successivi interventi di manutenzione straordinaria (con SCIA,
                CILA, ecc..)</b
              >
              <q-icon name="info">
                <q-tooltip anchor="top middle" self="bottom middle">
                  Riportare eventuali interventi successivi relativi
          ...
          <div
            ...
            v-if="
              value.elencoInterventiManutenzioneStraordinariaSCIACILAltro
                .length > 0
            "
          >
          ...
          <div
            v-for="(
              item, index
            ) in value.elencoInterventiManutenzioneStraordinariaSCIACILAltro"
            :key="item.message"
            style="border-bottom:1px solid black background-color:white; "
          >
            <div class="row" v-if="item.cancellare != '1'">
              ...
              <div class="col">
                <span
                  @click="
                    downloadFile(
                      value.idprogetto + '/' + item.allegato,
                      item.allegato
                    )
                  "
    ...
    <div style="" class="">
      <div class="">
        <div class="col-6">
          <label for=""><b>Titoli autorizzativi relativi ad interventi successivi alla  costruzione</b>
          </label>
        </div>
        <div class="col-2"></div>
      </div>
      <div class="row " style="background-color: white">
        ...
        <div class="col">
          <b><q-input v-model="InterventiSuccessiviNuovaDecrizione" :dense="true" outlined type="text" label="Successivi interventi"/></b>
        </div>
        <div class="col">
          <label>Allegato</label><br />
          <input type="file" @change="handleFile" />
      ...
      <div
        v-for="(
          item, index
        ) in value.elencoTitoliAutorizzatiInterventiSuccessivi"
        :key="item.message"
        style="border-bottom:1px solid black background-color:white; "
      >
        <div class="row" v-if="item.cancellare == '0'">
          ...
          <div class="col">
            <span
              @click="
                downloadFile(
                  value.idprogetto + '/' + item.nomeAllegato,
                  item.nomeAllegato
                )
              "
              style="cursor: pointer; text-decoration: underline"
            >
              {{ item.nomeAllegato }}</span
            >
          </div>
          <div class="col-1 col-md-1">
            <q-btn
              ...
              icon="delete"
              @click="
                value.elencoTitoliAutorizzatiInterventiSuccessivi.splice(
                  index,
                  1
                )
              "
            ...
            <q-btn
              ...
              icon="delete"
              @click="
                value.elencoTitoliAutorizzatiInterventiSuccessivi[
                  index
                ].cancellare = '1'
              "
            />
    ...
    <div style="background-color: white">
      ...
      <div class="row" style="padding-top: 10px">
        <div class="col-12">
          <label> <b>Dati catastali</b></label>
        </div>
      </div>
      ...
      <div
        class="row q-gutter-sm"
        v-for="(item, index) in value.elencoTitoliAutorizzatiDatiCatastali"
        :key="item.message"
      >
    ...
    <div class="bgmargintop q-gutter-sm">
      ...
      <div class="row" style="padding-top: 10px">
        ...
        <div class="col-12" v-if="value.abusiEdilizi == 'SI'">
          ...
          <q-input
            v-model="value.TipologiaAbusiEdilizi"
            type="text"
            :dense="true"
            outlined
          />
      ...
      <div class="row" style="padding-top: 10px">
        <div class="col-12">
          <strong
            >Il progetto in atto al comune risulta corrispondente allo stato di
            fatto:</strong
          >
        </div>
      ...
      <div class="row" style="padding-top: 10px">
        <div class="col-12">
          <strong
            >La planimetria censita al NCEU risulta corrispondente allo stato di
            fatto:</strong
          >
        </div>
      ...
      <div class="row" style="padding-top: 10px">
        <div class="col-12">
          <strong
            >Le eventuali irregolarità riscontrate sono sanabili***:</strong
          ><q-icon name="info"
            ><q-tooltip>
              Specificare che le attività di sanatoria sono a carico del
              condominio. Specificare che gli abusi verranno sanati prima della
              data di inizio lavori. Specificare le modalità e i tempi di
              sanatoria.
            </q-tooltip></q-icon
          >
        </div>
...
export default {
  ...
  methods: {
    ...
    createBase64TitoliAutorizzativi(fileObject) {
      ...
      this.value.Base64AllegatoTitoloAutorizzativo = reader.readAsBinaryString(
        fileObject
      );
    ...
    downloadFile(path, titoloFile) {
      Axios.post(this.linkApi + "/download/", { params: { pp: path } }).then(
        (response) => {
